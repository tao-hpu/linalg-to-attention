...
export function BowEmbedding() {
  ...
  return (
    <ChapterShell
      ...
      lede={
        <>
          要让模型读文本，第一步得把词变成向量。最朴素的办法是 <strong>one-hot</strong>：
          词表多大，向量就多长，只有自己那一位是 1。
          在它之上能搭出词袋（bag-of-words）和 TF-IDF——那两者衡量的是<em>文档</em>之间的相似度，
          至今仍在检索里好用。但回到<em>词</em>这一层，毛病躲不开：
          <strong>任意两个不同的词都「互相垂直」</strong>，
